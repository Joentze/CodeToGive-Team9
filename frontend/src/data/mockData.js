...
export const mockFoodDistributionByRegion = [
  {
    month: "Mar",
    "South West": 140,
    "Central": 210,
...
export const mockFoodRequests = [
  {
    recipientId: "R001",
    dateOfRequest: "2024-08-01T10:30:00Z",
  ...
  {
    recipientId: "R002",
    dateOfRequest: "2024-08-02T14:00:00Z",
    receivedAt: "2024-08-02T14:45:00Z",
    familySize: 2,
    canCook: false,
    canReheat: true,
    hasFridge: false,
    deliveryAddress: [1.3644, 103.9915],
    dietaryRestrictions: ["Vegan"],
    foodType: ["Prepared Meals"],
  },
  {
    recipientId: "R003",
    dateOfRequest: "2024-08-03T09:15:00Z",
    receivedAt: "2024-08-03T09:50:00Z",
    familySize: 3,
    canCook: true,
    canReheat: true,
    hasFridge: true,
  ...
  {
    recipientId: "R004",
    dateOfRequest: "2024-08-04T12:00:00Z",
    receivedAt: "2024-08-04T12:30:00Z",
    familySize: 5,
    canCook: true,
    canReheat: true,
    hasFridge: true,
    deliveryAddress: [1.3785, 103.8477],
    dietaryRestrictions: ["Halal"],
    foodType: ["Frozen Foods", "Snacks"],
  },
  {
    recipientId: "R005",
    dateOfRequest: "2024-08-05T16:45:00Z",
    receivedAt: "2024-08-05T17:15:00Z",
    familySize: 1,
    canCook: false,
    canReheat: true,
    hasFridge: false,
    deliveryAddress: [1.2919, 103.8500],
    dietaryRestrictions: ["No Dairy"],
    foodType: ["Prepared Meals"],
  },
  {
    recipientId: "R006",
    dateOfRequest: "2024-08-06T08:30:00Z",
    receivedAt: "2024-08-06T09:00:00Z",
    familySize: 6,
    canCook: true,
    canReheat: false,
    hasFridge: true,
  ...
  {
    recipientId: "R007",
    dateOfRequest: "2024-08-07T11:30:00Z",
    receivedAt: "2024-08-07T12:15:00Z",
    familySize: 3,
    canCook: false,
    canReheat: true,
    hasFridge: true,
    deliveryAddress: [1.3224, 103.9312],
    dietaryRestrictions: ["Halal"],
    foodType: ["Dry Goods", "Prepared Meals"],
  },
  {
    recipientId: "R008",
    dateOfRequest: "2024-08-08T14:20:00Z",
    receivedAt: "2024-08-08T14:50:00Z",
    familySize: 2,
    canCook: false,
    canReheat: false,
    hasFridge: false,
  ...
  {
    recipientId: "R009",
    dateOfRequest: "2024-08-09T10:00:00Z",
    receivedAt: "2024-08-09T10:30:00Z",
    familySize: 4,
    canCook: true,
    canReheat: true,
    hasFridge: true,
  ...
  {
    recipientId: "R010",
    dateOfRequest: "2024-08-10T18:00:00Z",
    receivedAt: "2024-08-10T18:30:00Z",
    familySize: 1,
    canCook: false,
    canReheat: true,
    hasFridge: false,
    deliveryAddress: [1.2977, 103.8535],
